...
export default function MainPage() {
  const categories = [
    ...
    { name: "Data Structures", problems: 500, solved: 65 },
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-gray-200 p-6">
      ...
      <div className="w-full max-w-5xl mx-auto mb-6">
        <img src="/src/assets/banner1.png" alt="Coding banner" />
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="bg-[#12172b] rounded-lg p-4 flex items-center justify-between border border-gray-700 shadow-lg">
          <div className="text-lg font-medium">
            Problem: <span className="text-blue-400">Find the Missing Number</span>
          </div>
          <div className="text-lg">
            Level: <span className="text-yellow-400">Medium</span>
          </div>
          <div className="text-lg">
            Attempted By: <span className="text-green-400">220</span>
          </div>
        ...
        {categories.map((category, index) => (
          ...
          >
            ...
            <div className="flex justify-between mt-4 text-gray-400">
              <div>
                Problems: <span className="text-white">{category.problems}</span>
              </div>
              <div>
                Solved: <span className="text-green-400">{category.solved}</span>
              </div>
            </div>
          </div>
        ))}
      ...
      <div className="bg-[#12172b] rounded-lg p-6 border border-gray-700 shadow-lg">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-400">
            <span className="text-green-400 font-semibold">New Feature:</span> Integrated Debugging Tool
          </p>
        </div>
      </div>
    </div>
